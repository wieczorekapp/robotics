...
def position_by_v_w(start_position_fi, start_position_x, start_position_y, w_v, Tp, start_position_x_k_l, start_position_y_k_l, start_position_x_k_p, start_position_y_k_p):
    ...
    # potrzebne do kółek, oddalenie od środka
    d = 0.145
...
def calculate_P_coordinates(x,y,a,b,fi):
    """
    Na podstawie zadanych wartości x, y, fi środka platformy, wyznacza jakie będą współrzędne
...
def main():
    ...
    # wyznaczenie prominie napodstawie prędkości liniowej podzielonej przez kątową
    calculate_r(w_v)
